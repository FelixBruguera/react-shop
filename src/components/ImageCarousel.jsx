...
const ImageCarousel = ({ images, alt }) => {
  ...
  return (
    <div>
      <dialog ref={bigImg}>
        <X
          className={`${styles.closeModal} ${styles.icon}`}
          onClick={() => bigImg.current.close()}
        />
        <div className={styles.openImageContainer}>
          <button
            ...
            aria-hidden={previousButtonHidden}

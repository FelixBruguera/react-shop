  ...
  return (
    <div className={styles.shop}>
      ...
      <ul className={styles.products}>
        {[...Array(8).keys()].map((i) => {
          return (
            <li key={i} className={productStyles.smallProduct}>
              <div className={productStyles.link}>
                <span
                  className={`${productStyles.image} ${productStyles.loadingImage}`}
                />
                <span
                  className={`${productStyles.title} ${productStyles.loadingTitle}`}
                />
              </div>
              <div className={productStyles.productData}>
                <div className={productStyles.priceBuy}>
                  <span
                    className={`${productStyles.price} ${productStyles.loadingPrice}`}
                  />
